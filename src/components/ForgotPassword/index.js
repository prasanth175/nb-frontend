...
class ForgotPassword extends Component {
  ...
  onSetPassword = async () => {
    ...
    const setPasswordUrl = 'https://novelty-bookstore.vercel.app/set-password'
    const options = {
      headers: {
  ...
  generateOTP = async () => {
    ...
    const otpUrl = 'https://novelty-bookstore.vercel.app/generate-otp'
    try {
      await fetch(otpUrl, {
        method: 'POST',
        headers: {
  ...
  verifyOTP = async () => {
    ...
    const otpUrl = 'https://novelty-bookstore.vercel.app/verify-otp'
