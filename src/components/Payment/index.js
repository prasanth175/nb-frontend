...
class Payment extends Component {
  ...
  componentDidMount = async () => {
    ...
    const {params} = match
    const {id} = params
    const paymentUrl = `https://novelty-bookstore.vercel.app/payments/${id}`
  ...
  getUserMail = async () => {
    ...
    const mailUrl = 'https://novelty-bookstore.vercel.app/mail-details'
    const options = {
      headers: {
  ...
  createOrder = async () => {
    ...
    const orderUrl = 'https://novelty-bookstore.vercel.app/create-order'
